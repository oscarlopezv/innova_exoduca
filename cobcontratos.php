...
$(document).ready(function () {		
	...
	$("#grid").kendoGrid({
		...
		excel: {
            fileName: "cobranza_contratos.xlsx",
			      proxyURL: "excel/",
            filterable: true,
            allPages: true
        },
		...
		columns: [
            ...
            { field: "oficina", title:"Oficina", width:"185px",hidden:true, exportable: { excel: true}},
            { field: "usreg", title:"User_Reg.",width:"225px",hidden:true, exportable: { excel: true}},
            { field: "fecha_registro", title:"Fec_Reg.", width:'125px',template:"#= kendo.toString(data.fecha,'dd-MM-yyyy')#",hidden:true, exportable: { excel: true}},
            { field: "usact", title:"User_Act.",width:"225px",hidden:true, exportable: { excel: true}},
            { field: "fecha_actualiza", title:"Fec_Act.", width:'145px',template:"#= kendo.toString(data.fecha_actualizar,'dd-MM-yyyy')#",hidden:true, exportable: { excel: true}},

            { field: "tmail", title:"Email", width:"105px",hidden:true, exportable: { excel: true}},
            { field: "ttelefonos", title:"Telefonos", width:"105px",hidden:true, exportable: { excel: true}},
...
$("#grid").data("kendoGrid").bind("excelExport", function (e) {
    if (!exportFlag) {
        ...
        e.sender.showColumn('fecha');
        e.sender.showColumn('oficina');
        e.sender.showColumn('usreg');
        e.sender.showColumn('fecha_registro');
        e.sender.showColumn('usact');
        e.sender.showColumn('fecha_actualiza');

        e.sender.showColumn('tmail');
        e.sender.showColumn('ttelefonos');
        ...
        e.sender.hideColumn('fecha');
        e.sender.hideColumn('oficina');
        e.sender.hideColumn('usreg');
        e.sender.hideColumn('fecha_registro');
        e.sender.hideColumn('usact');
        e.sender.hideColumn('fecha_actualiza');

        e.sender.hideColumn('tmail');
        e.sender.hideColumn('ttelefonos');
